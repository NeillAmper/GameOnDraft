...
public class GameMaster extends javax.swing.JFrame {
    ...
    private final String gameMasterName; // Declare the correct variable

    public GameMaster(String usname) {
        this.gameMasterName = usname; // ✅ Store the passed value into the correct variable
        initComponents();
    ...
    private void CreateQuizActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateQuizActionPerformed
        CreateQuiz c = new CreateQuiz(gameMasterName); // ✅ Correct: passes actual signed-in username
        c.setVisible(true);
        setVisible(false);
    ...
    private void EditQuizActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditQuizActionPerformed
        EditQuizTable e = new EditQuizTable(); // No parameters
        e.setVisible(true);
        setVisible(false);
    ...
    private void LeaderboardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LeaderboardActionPerformed
        Leaderboard l = new Leaderboard("GameMaster");
        l.setVisible(true);
        setVisible(false);
    }//GEN-LAST:event_LeaderboardActionPerformed

    private void HistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HistoryActionPerformed
        History h = new History("GameMaster");
        h.setVisible(true);
        setVisible(false);
    }//GEN-LAST:event_HistoryActionPerformed

    private void ProfileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProfileButtonActionPerformed
        Profile p = new Profile("GameMaster", gameMasterName); // ✅ Pass both user type and name
        p.setVisible(true);
        setVisible(false);
